...
object OnboardingData {
    val pages = listOf(
        OnboardingPage(
            ...
            imageResId = R.drawable.ic_onboarding_discover // Örn: Bir büyüteç veya film makarası ikonu
        ),
        OnboardingPage(
            ...
            imageResId = R.drawable.ic_onboarding_favorite // Örn: Bir kalp veya yer imi ikonu
        ),
        OnboardingPage(
            ...
            imageResId = R.drawable.ic_onboarding_details // Örn: Bir bilgi (i) ikonu veya kişi ikonu
        )
    )
}